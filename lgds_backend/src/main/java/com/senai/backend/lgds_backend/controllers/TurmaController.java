...
import com.senai.backend.lgds_backend.services.TurmaService;
...
public class TurmaController {
    ...
    public ResponseEntity<Turma> buscarPorId(@PathVariable Integer id) {
        Optional<Turma> obj = service.buscarPorId(id);
        if (obj.isPresent()) {
